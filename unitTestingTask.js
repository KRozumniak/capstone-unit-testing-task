(function (root, factory) {
     ...
     * @return {String}
     */
    var leadingZeroes = unitTestingTask.leadingZeroes = (value, length) => {
    ...
    var tokens = unitTestingTask.tokens = {
        YYYY: function (date) {
     ...
     * @type {Object}
     */
    var languages = unitTestingTask.languages = unitTestingTask._languages = {};
